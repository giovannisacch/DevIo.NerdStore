...
namespace DevIo.NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        //Classe aninhada fica bom pra nao ter que usar o ctor completo pra criar um rascunho
        public static class PedidoFactory
        {
            public static Pedido NovoPedidoRascunho(Guid clienteId)
            {
                //Consegue acessar o ctor protected pois esta dentro da classe
